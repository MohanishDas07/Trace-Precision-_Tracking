  ...
  (
    ...
    return (
      <motion.div
        ...
        className={cn(
          "relative h-[26rem] w-full max-w-[20rem] rounded-2xl bg-transparent shadow-2xl border border-white/10",
          className
        )}
      >
        <div
        ...
        >
          ...
          <div className="relative z-10 flex h-full w-full flex-col justify-between rounded-xl p-4 text-white">
            ...
            <div className="flex items-start justify-between">
              ...
              <motion.a
                ...
                className="relative z-20 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm ring-1 ring-inset ring-white/30 transition-colors hover:bg-white/30 ml-4"
              >
            ...
            <motion.button
              onClick={(e) => {
                e.stopPropagation(); // Prevent card from handling the click if there was a wrapper
                onActionClick();
              }}
              ...
              style={{ transform: "translateZ(40px)" }}
              className={cn(
                "relative z-20 w-full rounded-lg py-3 text-center font-semibold text-white transition-colors cursor-pointer pointer-events-auto",
